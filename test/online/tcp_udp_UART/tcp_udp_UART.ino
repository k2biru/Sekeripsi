...
#ifdef MODE_AP
// For AP mode:
const char *ssid = "MIDI";  // You will connect your phone to this Access Point
const char *pw = "MIDIMIDI"; // and this is the password
IPAddress ip(192, 168, 34, 55); // From RoboRemo app, connect to this IP
...
void loop() {
  ...
  if(Serial.available()) {
    ...
    // now send to WiFi:  
    udp.beginPacket("192.168.34.255", 1112); // remote IP and port
    udp.write(buf2, i2);
    udp.endPacket();
    i2 = 0;
  }
